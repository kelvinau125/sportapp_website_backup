    ...
    <div ref="downloadApp" v-if="!isMobileView" v-show="isVisible" class="downloadApp">
      ...
      <div class="w-[251px] h-[126px] bg-white rounded-lg flex justify-evenly items-center">
        <div class="flex flex-col items-center">
          <span class="w-[110px]  text-10px font-normal text-center pb-2" style="color: rgba(153, 153, 153, 1);">{{$t("Scan the QR code to download the latest installation package")}}</span>
