            ...
            <div class="live-container">
                <div class="relative rounded-lg">
                    <div class="bg-gray-200  w-[1037px] h-[587px]">
                        ...
                        <video class="cursor-pointer w-full h-full" preload="auto" controls autoplay :poster="posterImage">
                    ...
                    <div class="w-full flex headerBox items-center md:pt-4 pt-3 md:pl-2 pb-2 ">
                        <div class="pl-3">
                            <img class="rounded-[50%] z-10 w-[30px] h-[30px] " :src="this.StreamIcon" alt="Image" />
                        </div>
                ...
                <div class="flex">
                    <div class="pr-4 pl-1">
                        <input class="w-[140px] pl-3 rounded-[24.46px] h-[44px] font-normal text-xs" v-model="messageInput"
                            placeholder="输入内容" type="text" @keyup.enter="toSendMessage" maxlength="50" />
                    </div>
                    <div class="mt-1">
