  ...
  <div class="otp-verification-modal" v-show="showOTPModal">
    <div class="modal-content">
      ...
      <form @submit.prevent="">
        ...
        <!-- false / false  -->
        <h2
          v-show="!isRegisterSuccess && !isResetPasswordSuccess"
        ...
        <!-- done register -->
        <h2 v-show="isRegisterSuccess" class="text-xl font-bold" style="padding: 20px">
          {{ $t("Register Successful") }}
        </h2>

        <!-- done reset password -->
        <h2
          v-show="isResetPasswordSuccess"
          class="text-xl font-bold"
          style="padding: 20px"
        >
          {{ $t("OTP Verify Successful!") }}
        </h2>
        ...
        <!-- true / false / false  -->
        <div
          v-show="warningMessage && !isRegisterSuccess && !isResetPasswordSuccess"
        ...
        <div class="pt-12">
          ...
          <!-- done register -->
          <ButtonCom v-show="isRegisterSuccess" @click="gobacklogin" class="w-screen">{{
            $t("Back to Login")
          }}</ButtonCom>
          ...
          >
            <p>
              ...
              <button class="text-green-500" v-show="isbuttonDisabled" disabled>
                {{ countdownMsg }}
              </button>
            </p>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      controllers: [{ value: "" }, { value: "" }, { value: "" }, { value: "" }],
  ...
  methods: {
    ...
    async verify() {
      const OTPvalue = this.controllers
