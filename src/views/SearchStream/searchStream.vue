        ...
        <div class="inner-container">
          <div class="schedule_detail">
            <div class="schedule_detail_box">
              ...
              <div class="flex flex-col items-start px-5" v-else-if="filterSearchResult.length === 0">
                <div v-if="startToSearch == true" class="flex flex-row items-center justify-center w-full">
                  ...
                  <div class="h-[120px] p-5">
                    <div class="flex justify-between">
                      <div class="flex items-center justify-start" style="width: 350px">
                        ...
                        <div class="px-3 flex justify-center ml-2 MatchTypeBorder w-32">
                        ...
                        <div class="">
                            <div class="max-[893px]:flex flex-row items-end px-5 min-[892px]:hidden">
                                <div class="pr-2 font-medium text-xs text-grayText max-[756px]:hidden">
                    ...
                    <div class="min-[320px]:flex justify-center">
                      <div class="min-[893px]:flex items-end pr-5 max-[892px]:hidden">
                      ...
                      <div class="flex py-3" style="width: 570px">
                        <div class="max-[892px]:flex justify-end items-center w-[50%] min-[893px]:flex justify-end items-center w-full ">
                          <div class="w-[90px] overflow-hidden text-left truncate">
                            <span
                              class="min-[893px]:text-lg font-medium pr-2 whitespace-nowrap overflow-ellipsis max-[892px]:text-lg font-medium pr-2 whitespace-nowrap"
                        ...
                        <div class="max-[892px]:flex items-center justify-start w-[50%] min-[893px]:flex items-center justify-start w-full">
                          ...
                          <div class="pl-3 w-[90px] overflow-hidden text-right truncate">
                            <span
      ...
      async search() {
        try {
          ...
          if (this.searchQuery === "") {
            ...
            this.startToSearch = true; //User start to search
          } else {
