  ...
  <div class="my-page-modal" v-show="showStreamDetailModal">
    <div class="modal-content">
      ...
      <div>
        ...
        <div class="flex pt-5">
          <p class="text-lg font-normal mt-2 mb-2 flex items-start">
            {{ $t("Category") }}
          </p>
          <select
            ...
            class="ml-5"
            required
            style="border: 1px solid #ccc; width: 117px"
          >
        ...
        <div class="flex flex-col items-start pt-5">
          ...
          <p
            class="text-gray-400 text-sm font-normal mt-2 cursor-pointer"
            @click="copyToClipboard(true)"
          >
            {{ this.host }}
          </p>
        ...
        <div class="flex flex-col items-start pt-5">
          ...
          <p
            class="text-gray-400 text-sm font-normal mt-2 h-16 break-all text-left cursor-pointer"
            @click="copyToClipboard(false)"
          >
            {{ this.code }}
          </p>
...
export default {
  ...
  data() {
    return {
      ...
      warningMessage: "",
      selectedSport: ref(
        localStorage.getItem("currentChannel") === "football" ? "0" : "1"
      ),
    };
  },
  ...
  methods: {
    ...
    copyToClipboard(details) {
      ...
      details ? (textToCopy = this.host) : (textToCopy = this.code);
