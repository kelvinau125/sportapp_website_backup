    ...
    <div class="modal-content">
      ...
      <div>
          ...
          <div @click="toLiveStream" class="card-body relative">
            <div class="w-full h-full border-2">
              <img
                ...
                :src="streamDetailsData.imageUrl"
                alt="Image"
              />
            </div>
            <div
            ...
            >
              ...
              <div class="flex flex-col pl-1 items-start w-[200px] z-10">
                <div
                  class="font-normal text-sm text-white text-start multiline-ellipsis w-[210px]"
                >
                  {{ streamDetailsData.title }}
                </div>
                <div
                  class="text-10px text-white font-bold opacity-60 text-start multiline-ellipsis w-[210px]"
                >
                  {{ nickname }}
                </div>
              </div>
        ...
        <div class="flex flex-col items-start pt-5 pl-10">
          ...
          <p class="text-gray-400 text-sm font-normal mt-2 h-16 break-all text-left">
            {{ streamDetailsData.time }}
          </p>
        </div>
      </div>
      ...
      <div class="pt-8">
        <ButtonPress
          ...
          style="height: 56px"
          >{{ $t("Start live broadcast") }}</ButtonPress
        >
  ...
  methods: {
    ...
    async startStream() {
      const result = await createStream(
        this.streamDetailsData.selectedSport,
        this.streamDetailsData.time,
        this.streamDetailsData.host,
        this.streamDetailsData.code,
        this.streamDetailsData.file,
        this.streamDetailsData.title
      );
