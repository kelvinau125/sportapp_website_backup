<template>
  ...
  <div class="flex justify-center ">
    <div class="w-full md:w-[897px] flex flex-col">
  ...
  <div style="border: 1px solid red;" class="flex justify-center">
    <div style="border: 1px solid red;" class="w-full md:w-[892px] flex flex-col">
      <h2 class="text-headerFont font-headerWeight">{{ $t("Tournament Status") }}</h2>
      <div class="pt-1">
        <TournamentStatus :tournamentID="this.TournamentID" :homeFormation="homeFormation" />
      </div>
  ...
  <!-- <div style="border: 1px solid black;" class="w-[892px]">
    <div class="flex justify-center">
      <div style="border: 1px solid red;" class="flex   pt-8">
        <div class="pt-1">
          <TournamentStatus :tournamentID="this.TournamentID" :homeFormation="homeFormation" />
        </div>
      </div>
